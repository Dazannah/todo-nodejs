;(function (e, t) {
  ...
  return (function () {
    ...
    function sr(e, t, r) {
      var n = { "HX-Request": "true", "HX-Trigger": Q(e, "id"), "HX-Trigger-Name": Q(e, "name"), "HX-Target": ee(t, "id"), "HX-Current-URL": te().location.href }
    ...
    function fr(e, t) {
      ...
      var n = { swapStyle: ie(e).boosted ? "innerHTML" : Y.config.defaultSwapStyle, swapDelay: Y.config.defaultSwapDelay, settleDelay: Y.config.defaultSettleDelay }
    ...
    function wr(e, t, r) {
      ...
      if (r) {
        if (r instanceof Element || L(r, "String")) {
          ...
          return ce(e, t, s(r.source), r.event, { handler: r.handler, headers: r.headers, values: r.values, targetOverride: s(r.target), swapOverride: r.swap, returnPromise: true })
        }
      } else {
    ...
    function ce(e, t, n, r, i, M) {
      ...
      var H = { boosted: W, useUrlParams: q, parameters: R, unfilteredParameters: z, headers: E, target: l, verb: e, errors: C, withCredentials: i.credentials || O.credentials || Y.config.withCredentials, timeout: i.timeout || O.timeout || Y.config.timeout, path: t, triggeringEvent: r }
      ...
      var I = { xhr: b, target: l, requestConfig: H, etc: i, boosted: W, pathInfo: { requestPath: t, finalRequestPath: A, anchor: L } }
      b.onload = function () {
        try {
          var e = Sr(n)
      ...
      ae(["loadstart", "loadend", "progress", "abort"], function (t) {
        ae([b, b.upload], function (e) {
          e.addEventListener(t, function (e) {
            fe(n, "htmx:xhr:" + t, { lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total })
          })
        })
      })
    ...
    function Tr(l, u) {
        ...
        var x = function () {
          try {
            ...
            if (t.elt && !oe(t.elt) && Q(t.elt, "id")) {
              ...
              var a = { preventScroll: h.focusScroll !== undefined ? !h.focusScroll : !Y.config.defaultFocusScroll }
              if (i) {
      ...
      if (a) {
        ue(l, "htmx:responseError", se({ error: "Response Status Error Code " + f.status + " from " + u.pathInfo.requestPath }, u))
      }
    }
    var Rr = {}
    function Or() {
